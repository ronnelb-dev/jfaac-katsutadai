...
const HISTORY = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1529070538774-1843cb3265df?w=900&q=85",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1438232992991-995b671e4437?w=900&q=85",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1504052434569-70ad5836ab65?w=900&q=85",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1609234656432-603f3f13c36d?w=900&q=85",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1445445290350-18a3b86e0b5a?w=900&q=85",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1531058020387-3be344556be6?w=900&q=85",
...
const SectionHeader = memo(({ pill, heading, accent, body }) => (
  <div className="mb-20 flex flex-col items-center text-center">
    ...
    <h2 className="text-3xl font-extrabold tracking-tight text-slate-800 sm:text-4xl lg:text-5xl">
      {heading} {accent && <span className="text-emerald-600">{accent}</span>}
    </h2>
    <div
      className="mt-4 h-1 w-12 rounded-full bg-emerald-500"
      aria-hidden="true"
    />
    {body && (
      <p className="mt-5 max-w-2xl text-base text-slate-500 sm:text-lg">
        {body}
      </p>
    )}
  </div>
        ...
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6">
          <figure>
            ...
            <blockquote className="text-xl font-semibold italic leading-relaxed text-slate-700 sm:text-2xl lg:text-3xl">
              "We did not build this church. God did — through ordinary people
              who were willing to say yes."
            </blockquote>
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <dl className="grid grid-cols-2 gap-8 text-center lg:grid-cols-4">
            {[
              ...
              <div key={label}>
                <dt className="text-3xl font-black text-white sm:text-4xl">
                  {value}
                </dt>
                <dd className="mt-1 text-xs font-semibold uppercase tracking-widest text-emerald-200">
                  {label}
                </dd>
              </div>
            ))}
